...
const NAV = {
  ...
  Owner:         [{ to: '/sales/dashboard', label: 'Dashboard' }, { to: '/members', label: 'Members' }, { to: '/sales/requests', label: 'Requests' }, { to: '/accounting/package-requests', label: 'Package Requests' }, { to: '/sales/team', label: 'Team' }, { to: '/sales/targets', label: 'Targets' }, { to: '/sales/transfer', label: 'Transfer' }, { to: '/sales/staff', label: 'Staff' }, { to: '/sales/packages', label: 'Packages' }, { to: '/sales/callcenter', label: 'Call Center' }, { to: '/checkin', label: 'Check In' }],
  Accountant:    [{ to: '/members', label: 'Members' }, { to: '/accounting/package-requests', label: 'Package Requests' }, { to: '/sales/targets', label: 'Revenue' }, { to: '/sales/team', label: 'Team' }, { to: '/checkin', label: 'Check In' }],
};
