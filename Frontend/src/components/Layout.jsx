...
const NAV = {
  ...
  Owner:         [{ to: '/owner/dashboard', label: 'Dashboard' }, { to: '/members', label: 'Members' }, { to: '/owner/teams', label: 'Teams' }, { to: '/sales/requests', label: 'Requests' }, { to: '/accounting/contract-history', label: 'Contracts' }, { to: '/sales/targets', label: 'Revenue' }, { to: '/sales/transfer', label: 'Transfer' }, { to: '/sales/packages', label: 'Packages' }, { to: '/sales/callcenter', label: 'Call Center' }, { to: '/checkin', label: 'Check In' }, { to: '/contacts', label: 'Contacts' }],
  Accountant:    [
