...
const NAV = {
  ...
  Accountant:    [{ to: '/members', label: 'Members' }, { to: '/accounting/package-requests', label: 'Package Requests' }, { to: '/accounting/contract-history', label: 'Contract History' }, { to: '/sales/targets', label: 'Revenue' }, { to: '/sales/team', label: 'Team' }, { to: '/checkin', label: 'Check In' }],
};
