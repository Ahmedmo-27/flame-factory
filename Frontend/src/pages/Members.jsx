...
function AddPersonModal({ open, onClose, packages, sales, onSuccess }) {
  const init = { name: '', phones: '', gender: '', birthdate: '', source: '', packageId: '', assignedSales: '' };
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await createMember({ name: form.name.trim(), phones: form.phones.trim(), gender: form.gender || null, birthdate: form.birthdate || null, source: form.source || null, packageId: form.packageId || null, assignedSales: form.assignedSales || null });
