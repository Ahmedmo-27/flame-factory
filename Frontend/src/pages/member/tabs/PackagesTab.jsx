import { Card, CardHeader, Badge, Table, EmptyState, fmtDate, fmtDateTime } from '../../../components/ui';
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <Card noPad>
        ...
        {!subs.length ? <EmptyState message="No subscriptions on record" /> :
          <Table headers={['Sub #', 'Package', 'Activity', 'Duration', 'Created At', 'Start', 'End', 'Price', 'Discount', 'Renewal']}>
